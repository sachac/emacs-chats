...
*Bozhidar:* But some of the packages are marked as new. I check them out. Often, some packages are suggested for inclusion in Prelude. I also operate the Twitter handle [[https://twitter.com/emacs_knight][@Emacs_Knight]] and people write to me all the time to promote some new packages, so I obviously try them out before promoting them.
...
*Sacha:* And [[https://twitter.com/emacs_knight][@emacs_knight]] for new package notes and other cool things.

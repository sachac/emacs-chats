...
Sacha: Yes. It actually surprisingly works well with a tablet PC.I have a screen that swivels around and becomes a tablet. So when you're drawing on the screen, that actually draws in Artist mode as well.
